 ...
 * 
 * 
 * The HashMap implements the singleton pattern. In this way the road map is
 * always unique and every game refers to the same map. The HashMap is
 * initialized with a private constructor. The HashSets are filled through a
 * specific method.
 * 
 * 
 * @author Andrea Celli
