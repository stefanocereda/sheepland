...
public enum Card implements Serializable {
	PLAIN_I(TerrainType.PLAIN, true, 0), PLAIN0(TerrainType.PLAIN, false, 0), PLAIN1(
	...
	COUNTRYSIDE_I(TerrainType.COUNTRYSIDE, true, 0), COUNTRYSIDE0(
	...
	MOUNTAIN_I(TerrainType.MOUNTAIN, true, 0), MOUNTAIN0(TerrainType.MOUNTAIN,
	...
	DESERT_I(TerrainType.DESERT, true, 0), DESERT0(TerrainType.DESERT, false, 0), DESERT1(
	...
	WOOD_I(TerrainType.WOOD, true, 0), WOOD0(TerrainType.WOOD, false, 0), WOOD1(
			TerrainType.WOOD, false, 1), WOOD2(TerrainType.WOOD, false, 2), WOOD3(
			TerrainType.WOOD, false, 3), WOOD4(TerrainType.WOOD, false, 4),

	LAKE_I(TerrainType.LAKE, true, 0), LAKE0(TerrainType.LAKE, false, 0), LAKE1(
