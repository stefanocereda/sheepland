...
/**
 * A game controller with advanced rules for games with two players / four
 * shepherds. It implements methods in common with GameControllerExtended and
 * with GameControllerTwoPlayers therefore there will be much duplicated code
 * 
 * @author stefano
 * 
 */
public class GameControllerExtendedTwoPlayers extends GameControllerExtended {
	...
	/**
	 * @param playerClients
	 *            an array with two clients
	 */
	public GameControllerExtendedTwoPlayers(List<ClientHandler> playerClients) {
		super(playerClients);
	}

	//
	//
	// HERE STARTS METHODS THAT ARE COPIED FROM THE STANDARD GAME CONTROLLER
	// WITH TWO PLAYERS
	//
	//
	 ...
	 * by moving the wolf or by asking the current player to choose a shepherd
	 */
	@Override
